...
| Folder | Notes | Source |
|--------|--------|--------|
| `MedSuite` | Unified med toolkit (auto hotkeys + defib revive + rebalance / continuous healing) | [mods/owned/MedSuite](https://github.com/gadjed/SPT-4.0.13-Mods/tree/main/mods/owned/MedSuite) |
...
- **ModPack 4.0.13** (`v1.2.17+`) ships the full server+client loadout (see MANIFEST in the zip), including **MedSuite 1.0.0** (auto med hotkeys + defib revive + rebalance), **YellowFlareCurse 1.4.6**, **Saria 2.0.5**, **PackItems**, **InsuranceControl 1.1.0**, **ModInventory**, **Skipper**, and **AmandsGraphics 1.7.0**
