...
namespace QuestingBots.Routers
{
    ...
    internal class ScavRaidSettingsRouter : AbstractStaticRouter
    {
        ...
        public ScavRaidSettingsRouter(LoggingUtil logger, ConfigUtil config, JsonUtil jsonUtil, LocationConfig locationConfig) : base(_routeNames, logger, config, jsonUtil)
        {
