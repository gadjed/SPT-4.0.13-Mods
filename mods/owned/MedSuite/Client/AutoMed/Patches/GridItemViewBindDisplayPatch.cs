...
namespace MedSuite.Client.AutoMed.Patches;
...
internal class GridItemViewBindDisplayPatch : ModulePatch
{
    protected override MethodBase GetTargetMethod()
    {
        ...
        throw new InvalidOperationException("[MedSuite:AutoMed] GridItemView.NewGridItemView not found.");
    }
    ...
    public static void Postfix(GridItemView __instance, TraderControllerClass itemController)
    {
        ...
        {
            MedSuitePlugin.Log.LogDebug($"[MedSuite:AutoMed] GridItemView bind display skipped: {ex.Message}");
        }
    }
}
