...
namespace MedSuite.Client.Healing;
...
internal static class HealingSession
{
    ...
    {
        if (!MedSuitePlugin.Healing.ScratchHeal.Value || player == null || medsItem?.MedKitComponent == null)
        {
            return;
        }
        ...
        var amountPerLimb = MedSuitePlugin.Healing.ScratchHealAmount.Value;
        var maxMissing = MedSuitePlugin.Healing.ScratchMaxMissingHp.Value;
