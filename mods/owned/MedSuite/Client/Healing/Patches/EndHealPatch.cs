...
internal class EndHealPatch : ModulePatch
{
    ...
    private static bool Prefix(Player.MedsController.ObservedMedsControllerClass __instance, IEffect effect)
    {
        ...
        if (!MedSuitePlugin.Healing.ContinuousHealing.Value)
        {
            HealingSession.End();
            return true;
        }
        ...
        var allowMedical = MedSuitePlugin.Healing.HealLimbs.Value && item is MedicalItemClass;
        ...
        ActiveHealthController.GClass3008.GClass3019_0.MedEffect.MedKitStartDelay =
            MedSuitePlugin.Healing.HealDelay.Value;
        ...
        if (MedSuitePlugin.Healing.ResetAnimation.Value && item is not MedicalItemClass)
        {
