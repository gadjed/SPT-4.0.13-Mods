...
public record ModMetadata : AbstractModMetadata
{
    ...
    public override string Name { get; init; } = "Insurance Control";
    ...
    // Client-only InsureAllPrapor is replaced by InsuranceControl.Client (same package).
...
) : IOnLoad
{
    ...
    public Task OnLoad()
    {
        ...
        logger.Success(
            $"[InsuranceControl] Loaded v1.1.0. Return={effectiveReturn}s"
